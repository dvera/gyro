...
#'
#' \code{macs2} is a wrapper for \code{macs2 callpeak}.
#'
...
macs2 <- function ( treatmentFiles , controlFiles=NULL , genomeSize = "hs" , inputFormat = "AUTO" , noLambda=TRUE , sampleNames = NULL , callSummits = TRUE , qvalue = 0.01 , verbosity = 3 , threads=getOption("threads",1L) ){

bcftoolsCall <- function( bcfFiles , outputType="v" , consensusCaller=TRUE , multiAllelicCaller=FALSE , variantsOnly=TRUE, insertMissed=FALSE, regions=NULL, threads=getOption("threads",1L) ){
